...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="container position-relative">
            <div class="banner-content-wrapper">
                <div class="banner-content">
                    <h1 class="banner-heading banner-text">
    ...
    <form id="form1" runat="server">
        ...
        <section class="section-block ow-bg" style="padding-top:50px !important;padding-bottom:0px !important;">
            <div class="container">
                <div class="row">
                    <div class="col-12 d-flex justify-content-center mb-3">
                        <div class="d-flex flex-wrap align-items-center" style="gap: 10px;">
                            <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control txtBorder" placeholder="Search product..." Width="250px" onkeypress="if(event.keyCode==13){document.getElementById('<%= btnSearch.ClientID %>').click(); return false;}" />
                            <asp:Button ID="btnSearch" runat="server" Text="Search" CssClass="LearnMrBtn btn btn-round-primary btn-style text-white" OnClick="btnSearch_Click" BackColor="#cfbbb0" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section id="OurProgress" class="section-block ow-bg">
            <div class="container">
                <div id="regenerative-wellness" class="tabcontent" style="display: block;">
                    <div class="grid-post-list">
                        <asp:Repeater ID="ServiceData" runat="server">
                            <ItemTemplate>
                                <div class="post-col">
                                    <div class="fullpostclickable"><a href="ServiceDetail.aspx?Id=<%# Eval("mProductId")%>"></a></div>
                                    <figure>
                                        <img alt="" src="<%#Eval("mProductImage")%>" class="lazyloaded" decoding="async">
                                    </figure>
                                    <div class="post-content">
                                        <h3><a href="ServiceDetail.aspx?Id=<%# Eval("mProductId")%>"><%#Eval("mProductName")%> </a></h3>
                                        <div class="dsceshort">
                                            <p><%#Eval("ProductDescription")%></p>
                                        </div>
                                        <a class="LearnMrBtn btn btn-round-primary btn-style text-white" href="ServiceDetail.aspx?Id=<%# Eval("mProductId")%>" style="background: #8C7B73">Learn more </a>
                                    </div>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-57b2bc0 img-round-shadow-2 elementor-widget elementor-widget-image" data-id="57b2bc0" data-element_type="widget" data-widget_type="image.default">
                            <div class="elementor-widget-container">
                                <asp:Image ID="imgKeyImage" runat="server" loading="lazy" decoding="async" Width="550" Height="480" class="attachment-large size-large wp-image-4674" alt="Service Image" sizes="auto, (max-width: 940px) 100vw, 940px" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-5bf1c6e treatment-col" data-id="5bf1c6e" data-element_type="column">
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-047a1c1 elementor-widget elementor-widget-text-editor" data-id="047a1c1" data-element_type="widget" data-widget_type="text-editor.default">
                            <div class="elementor-widget-container">
                                <h2>Key Benefits</h2>
                                <asp:Literal ID="ltrKey" runat="server" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-f1dbe96 elementor-widget__width-initial elementor-widget elementor-widget-text-editor" data-id="f1dbe96" data-element_type="widget" data-widget_type="text-editor.default">
                            <div class="elementor-widget-container text-white">
                                <h2>
                                    <span style="color: black;"><span style="font-size: 59.2px;">Brand Key Point</span></span>
                                </h2>
                                <ul class="arrow-bullet">
                                    <li aria-level="1" style="color: black; list-style:disc !important">Curated by Functional Medicine Experts , Biohackers & Supported By cutting edge Biomarkers.</li>
                                    <li aria-level="1" style="color: black; list-style:disc !important">Post-Therapy Monitoring & Wellness Coaching.</li>
                                    <li aria-level="1" style="color: black; list-style:disc !important">Clinically validated outcomes with hundreds of satisfied Customer Base.</li>
                                    <li aria-level="1" style="color: black; list-style:disc !important">Medical-Grade Safety, Protocols & Privacy</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="elementor-element elementor-element-74df8cd img-round-shadow-2 elementor-widget elementor-widget-image" data-id="74df8cd" data-element_type="widget" data-widget_type="image.default">
                            <div class="elementor-widget-container">
                                <figure class="wp-caption">
                                    <img loading="lazy" decoding="async" loading="lazy" width="550" height="480" src="assets/Services/key-points.jpg" class="attachment-large size-large wp-image-4676" alt="Service Key Points" sizes="auto, (max-width: 940px) 100vw, 940px" />
