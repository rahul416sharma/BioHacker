<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ServiceDetail.aspx.cs" Inherits="Default2" %>
        ...
        <div class="container position-relative">
            <div class="banner-content-wrapper">
                <div class="banner-content">
                    <h1 class="banner-heading banner-text"><asp:Label ID="lblHeading" runat="server" /></h1>
                    <div class="row mt-5">
                        <div class="col-md-6">
                            ...
                            <div class="elementor-widget-wrap elementor-element-populated">
                                <div class="elementor-element elementor-element-f1dbe96 elementor-widget__width-initial elementor-widget elementor-widget-text-editor" data-id="f1dbe96" data-element_type="widget" data-widget_type="text-editor.default">
                                    <div class="elementor-widget-container">
                                        <h2>
                                            <span><span style="font-size: 59.2px;"><%#Eval ("mProductName") %></span></span>
                                        </h2>
                                        <p>
                                        <p style="color:black;font-weight:bold"><%#Eval ("mProductDescription") %></p>
                                            </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="elementor-element elementor-element-74df8cd img-round-shadow-2 elementor-widget elementor-widget-image" data-id="74df8cd" data-element_type="widget" data-widget_type="image.default">
                                    <div class="elementor-widget-container">
                                        <figure class="wp-caption">
                                            <img loading="lazy" decoding="async" loading="lazy" width="940" height="907" src="<%#Eval ("mProductImage") %>" alt="<%#Eval ("mProductName") %>" class="attachment-large size-large wp-image-4676" sizes="auto, (max-width: 940px) 100vw, 940px" />
                ...
                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-81b3c7a" data-id="81b3c7a" data-element_type="column">
                    <div class="elementor-widget-wrap elementor-element-populated">
                        <div class="elementor-element elementor-element-57b2bc0 img-round-shadow-2 elementor-widget elementor-widget-image" data-id="57b2bc0" data-element_type="widget" data-widget_type="image.default">
                            <div class="elementor-widget-container">
                                <asp:Image ID="imgKeyImage" runat="server" loading="lazy" decoding="async" width="940" height="480" class="attachment-large size-large wp-image-4674" alt="Service Image" sizes="auto, (max-width: 940px) 100vw, 940px" />
                            </div>
                        </div>
                    </div>
                </div>
