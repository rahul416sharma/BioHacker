<%@ Page Title="" Language="C#" MasterPageFile="~/Software/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="AddBlog.aspx.cs" Inherits="Software_Admin_Default2" %>
					...
					<div class="card-body">
						...
						<div class="form-row">
							<div class="col-6">
								...
								<select class="form-control" style="height: 43px;">

									<option value="">--Select Category--</option>
									<option value="1">Fitness Biohackers</option>
									<option value="2">Sleep Improvment</option>
							...
							<div class="col-6">
								...
								<input type="text" id="Sub_Title" ng-modal="Sub-Title" class="form-control" placeholder="Sub-Title">
							</div>
							<div class="col-6">
									...
									<tbody>
										<tr ng-repeat="d in SubCategoryData">
											...
											<td style="text-align: center">
												...
												&nbsp<a class="tip" href="#" data-original-title="Delete" data-ng-click="delDetail(d.Id);"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
												&nbsp
											</td>
										</tr>
									</tbody>
