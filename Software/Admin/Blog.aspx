<%@ Page Title="" Language="C#" MasterPageFile="~/Software/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Blog.aspx.cs" Inherits="Software_Admin_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container" data-ng-app="Website">
        <div class="row" data-ng-controller="Blog">
            <div class="card">
				<div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
					<div class="card-body">
						<h1>Add Blog Image</h1>
						<br />
						<div class="row">
							<div class="col-6">
								<div class="mb-3">
							...
							<div class="col-6">
								<div class="mb-3">
									...
									<input type="text" id="Blog_Name" ng-modal="SubCategory_Name" class="form-control" placeholder="Blog Name">
								</div>
							</div>
							<div class="col-6">
								<div class="mb-3">
