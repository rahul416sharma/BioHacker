...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!-- Start Breadcrumbbar -->
    <div class="breadcrumbbar" data-ng-app="Website">
        <div class="row align-items-center" data-ng-controller="Dashboard">
            <div class="col-md-8 col-lg-8">
                <h4 class="page-title"><h1>WelCome {{logname}}</h1></h4>
            </div>
        </div>
    </div>
    <!-- End Breadcrumbbar -->
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/men.svg" class="img-fluid" width="35" alt="customer"></td>
                                                <td>John Doe</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/women.svg" class="img-fluid" width="35" alt="customer"></td>
                                                <td>Daniel Chris</td>
                                                <td>demo@example.com</td>
                                                <td>93%</td>
                                                <td>1300</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="assets/images/users/boy.svg" class="img-fluid" width="35" alt="customer"></td>
                                                <td>John Joshua</td>
                                                <td>demo@example.com</td>
                                                <td>87%</td>
                                                <td>1250</td>
