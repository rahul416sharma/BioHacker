<%@ Page Title="" Language="C#" MasterPageFile="~/Software/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="Mainmenu.aspx.cs" Inherits="Software_Admin_Default" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-6">
                                ...
                                <input type="text" id="Menu_Name" ng-modal="Category_Name" class="form-control" placeholder="Menu Name">
                            </div>
                            <div class="col-6">
                                <label for="inputEmail4">Menu Path*</label>
                                <input type="text" id="menu_path" ng-modal="Category_Name" class="form-control" placeholder="Menu Path">
                            </div>

                            <div class="col-4">
                                <br />
                                <input id="submit" ng-modal="submit" type="button" ng-click="submit()" class="btn btn-danger" value="Menu" />
                            </div>
                        </div>
                    </div>
                </div>
